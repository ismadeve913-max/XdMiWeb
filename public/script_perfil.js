document.addEventListener('DOMContentLoaded', () => {
    ...
    const spinningImage = document.getElementById('spinning-perfil-image');
    ...
    // Lógica para la imagen giratoria
    function startSpin() {
        if (spinningImage) {
            spinningImage.classList.add('is-spinning');
            setTimeout(() => {
                spinningImage.classList.remove('is-spinning');
            }, 5000);
        }
    }
    startSpin();
    setInterval(startSpin, 30000);
